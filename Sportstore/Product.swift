...
class Product: NSObject, NSCopying {
    ...
    init(name:String, description:String, category:String, price:Double, stockLevel:Int) {
        ...
        //Initializers of subclasses invoke the initializer of their superclass, but this must be done after the stored properties have been set and before the computed properties are used
        super.init();
